...
public class BindedCarApiImpl implements IBindedCarApi {
    ...
    public BindUserDto bindCar(String userId, Integer brandCode, String vin) throws ApiException {
        ...
        BindInfoPojo bindedFromCarService = carService.findVin(vin);
        List<BindInfoPojo> bindRecord = carService.findBindRecordBy(vin, Long.parseLong(userId), brandCode);
        ...
        BindInfoPojo bi = new BindInfoPojo();
        try {
    ...
    private void teslaFirstBindBounsPoint(String userId, Integer brandCode, List<BindInfoPojo> bindRecord) {
