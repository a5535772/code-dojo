...
@Data
@Builder
public class ResourcePoolLoomBookConfig {
    ...
    public static class InternalBuilder extends ResourcePoolLoomBookConfigBuilder {
        InternalBuilder() {
            super();
        }

        @Override
        public ResourcePoolLoomBookConfig build() {
            ResourcePoolLoomBookConfig model = super.build();
            model.valid();
            return model;
        }
    }

    public static ResourcePoolLoomBookConfigBuilder builder() {
